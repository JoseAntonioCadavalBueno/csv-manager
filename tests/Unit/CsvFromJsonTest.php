...
class CsvFromJsonTest extends TestCase
{
...
EOT;
    ...
    /**
     * Unitary test that generate a csv file from json
     *
     * @test
     */
    public function test_generate_a_csv_file_from_json()
    {
        if (class_exists('Illuminate\Support\Facades\Storage')) {
        ...
        $result = Csv::fromJson(self::RAW_DATA, $filename);
        $this->assertFileExists($result);
    }

    /**
     * Unitary test that generate a txt file from json
     *
     * @test
     */
    public function test_generate_a_txt_file_from_json()
    {
        if (class_exists('Illuminate\Support\Facades\Storage')) {
    ...
    /**
     * Unitary test that generate a csv file from not normalized json
     *
     * @test
     */
    public function test_generate_a_csv_file_from_not_normalized_json()
    {
        if (class_exists('Illuminate\Support\Facades\Storage')) {
            $filename = 'laravel_php.csv';
        } elseif (class_exists('Symfony\Component\Filesystem\Filesystem')) {
        ...
        $result = Csv::fromJson(self::NOT_NORMALIZED_DATA, $filename);
        $this->assertFileExists($result);
    }

    /**
     * Unitary test that generate a txt file from not normalized json
     *
     * @test
     */
    public function test_generate_a_txt_file_from_not_normalized_json()
    {
        if (class_exists('Illuminate\Support\Facades\Storage')) {
            $filename = 'laravel_php.txt';
        } elseif (class_exists('Symfony\Component\Filesystem\Filesystem')) {
